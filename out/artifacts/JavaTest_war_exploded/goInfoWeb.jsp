...
<div class="box">
    <ul class="left">
        ...
        <li>配送管理
            <ul>
                <li id="line"><a href="goInfoWeb.jsp">配送信息</a></li>
            </ul>
        </li>
        <li>管理员管理
            <ul>
        ...
        <table>
            ...
            <%
                ...
                for (int i = 0; i < list.size(); i++) {
                    if (list.get(i).getIspay().equals("已支付")) {
            %>
            <tr>
                ...
                <td><button onclick="location.href='ChangeSendServlet?id=<%=list.get(i).getOrderid()%>';">
                    <%=list.get(i).getIssend()%></button></td>
